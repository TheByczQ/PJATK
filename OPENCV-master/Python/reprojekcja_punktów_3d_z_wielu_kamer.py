...
"""
punkty 3D 1 klatki danych kamer
"""
           ...
           [np.array([[-618.22537143],
                      ...
                      [2004.98727637]])], [np.array([[-651.52938401],
                                                     ...
                                                     [2114.9273037]])], [np.array([[-618.42841475],
                                                                                   [174.49190186],
                                                                                   [2008.73583002]])],
           [np.array([[-610.34681555],
                      [171.61109399],
                      [1982.26692216]])], [np.array([[-605.01554597],
                                                     [166.07432803],
                                                     [1963.48125397]])]]
"""
współrzędne danych kamer 3D względem kamery 3.
"""
poczatekkamery3 = np.array([[0],
                            [0],
                            [0]])
poczatekkamery4 = np.array([[1253.72176163],
                            [-32.04345308],
                            [974.11997952]])
poczatekkamery2 = np.array([[-767.38397513],
                            [66.70297933],
                            [290.59956355]])
"""
metoda obliczająca uśrdenione punkty 3D na podstawie najbliższej odległości
między prostymi tworzonymi od punktu kamery do punkty widzianego przez nią w 3D
punkt jest rekonstruowany na środku wektora między punktami o najmniejszej 
odłegłośći

"""
zbiorwektorow = []
for i in range(len(punkty3)):
    line1 = np.array([[0.0, 0.0, 0.0], [punkty3[i][0][0][0], punkty3[i][0][1][0], punkty3[i][0][2][0]]])
    line2 = np.array(
        [[-767.38397513, 66.70297933, 290.59956355], [punkty2[i][0][0][0], punkty2[i][0][1][0], punkty2[i][0][2][0]]])
    intersect = intersect_line_line(line1[0], line1[1], line2[0], line2[1])
    srodek = intersect[0] - ((intersect[0] - intersect[1]) / 2)
    zbiorwektorow.append([srodek])
print(zbiorwektorow)
"""
wyświetlenie prostych i wykrytych punktów na nich między którymi odległość jest minimalna
"""
# X1 = [0.0,1481.96292089]
# Y1 = [0.0,-270.64741552]
# Z1 = [0.0,1247.27034469]
#
# X2 = [1253.72176163,1484.70906338]
# Y2 = [-32.04345308,-205.5890171]
# Z2 = [974.11997952,1239.77291725]
#
# fig = plt.figure()
# ax = fig.add_subplot(111,projection = '3d')
# ax.plot(X1,Y1,Z1)
# ax.plot(X2,Y2,Z2)
# ax.scatter(intersect[1][0],intersect[1][1],intersect[1][2],color = 'red',marker='o')
# ax.scatter(intersect[0][0],intersect[0][1],intersect[0][2],color = 'green',marker='v')
# plt.show()
